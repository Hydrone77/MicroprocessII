...
bool red_startup_flash = 1; // bit to set if red light should be flashing 1s ON 1s OFF - initialzied as 1 for startup routine
bool green1_halfhz_flash = 0; 
